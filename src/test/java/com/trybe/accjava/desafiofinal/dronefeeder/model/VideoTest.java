...
class VideoTest {
  ...
  void videoConstructorTest() {
    ...
    assertEquals("Casa Teste", video.getLocalizacao());
  ...
  void settersTest() {
    ...
    video.setLocalizacao("Nova localização");
    assertEquals("Nova localização", video.getLocalizacao());
